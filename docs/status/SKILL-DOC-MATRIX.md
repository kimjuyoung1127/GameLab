...
| `page-labeling-upgrade` | `/labeling/[id]` | `frontend/src/app/(dashboard)/labeling/[id]/page.tsx`, `frontend/src/app/(dashboard)/labeling/[id]/components/SpectrogramPanel.tsx`, `frontend/src/lib/hooks/use-segment-playback.ts`, `frontend/src/lib/audio/wav-export.ts`, `frontend/src/lib/audio/spectrogram-export.ts`, `frontend/src/lib/hooks/use-spectrogram.ts` | `docs/status/PROJECT-STATUS.md`, `docs/ref/schema.md`, `docs/ref/architecture-diagrams.md` | `feature-navigation-and-gesture`, `feature-error-and-retry-state` | hotkeys/save/undo regression-free + selection playback/export + single-click full fit/`BAND` focus + cursor sync/pitch preserve/0.25x speed/PNG export |
